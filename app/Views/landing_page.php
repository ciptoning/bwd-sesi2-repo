...
<body>
    ...
    <header class="bg-primary text-white text-center py-5">
        <div class="container py-5">
            ...
            <a href="#produk" class="btn btn-light btn-lg mt-3 fw-bold text-primary">LIHAT LAYANAN KAMI</a>
        </div>
    </header>
            ...
            <div class="row g-4">
                ...
                <article class="col-12 col-md-4">
                    <div class="box-model-demo h-100 text-center">
                        ...
                        <h3>Layanan Penjemputan Sampah</h3>
                        <p class="text-muted">Pick-Up Service yang memudahkan Anda mengelola sampah langsung dari rumah tanpa repot!</p>
                    </div>
                </article>
                ...
                <article class="col-12 col-md-4">
                    <div class="box-model-demo h-100 text-center">
                        ...
                        <h3>Sistem Pembayaran Tunai</h3>
                        <p class="text-muted">Trash-to-Cash memberikan keuntungan dengan mengubah sampah Anda menjadi uang saku secara langsung.</p>
                    </div>
                </article>
                ...
                <article class="col-12 col-md-4">
                    <div class="box-model-demo h-100 text-center">
                        ...
                        <h3>Kalkulasi Harga Transparan</h3>
                        <p class="text-muted">Kalkulasi harga jelas & transparan beserta guideline edukasi daur ulang sampah untuk Anda.</p>
                    </div>
                </article>
    ...
    <footer class="bg-dark text-light text-center py-4">
        <div class="container">
            <p class="mb-0">&copy;Abdul Rohman-25120100051 2026 Cakrawala Digital Business. <strong>BWD04 - Sesi 2</strong>.</p>
        </div>
    </footer>
