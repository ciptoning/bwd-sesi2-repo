...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#"><i class="fa-solid fa-rocket text-primary"></i>dessertHome</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#kontak">CekOut</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <header class="bg-primary text-white text-center py-5">
        <div class="container py-5">
            <h1 class="display-4">Pilihan tepat untuk kamu si pecinta manis</h1>
            <p class="lead mt-3">Dibuat dengan bahan-bahan berkualitas, cukup satu gigitan buat kamu jadi pengen lagi dan lagi..</p>
            <a href="#kontak" class="btn btn-light btn-lg mt-3 fw-bold text-primary">Order Now</a>
        </div>
    </header>
    ...
    <main>
        ...
        <section id="produk" class="container my-5 py-4">
            <div class="text-center mb-5">
                <h2>dessertHome</h2>
                <p class="text-muted">Sudah dibeli lebih dari 5000pcs, sekarang giliranmu!</p>
            </div>
            ...
            <div class="row g-4">
                ...
                <article class="col-12 col-md-4">
                    <div class="box-model-demo h-100 text-center">
                        ...
                        <h3>Bestseller</h3>
                        <p class="text-muted">Mau cari dessert viral? Disini tempatnya!</p>
                    </div>
                </article>
                ...
                <article class="col-12 col-md-4">
                    <div class="box-model-demo h-100 text-center">
                        ...
                        <h3>Dessert custome from Mobile</h3>
                        <p class="text-muted">Buat dessert versimu bisa dari mana saja dan kapan saja. Cukup gunakan smartphone yang kamu punya.</p>
                    </div>
                </article>
                ...
                <article class="col-12 col-md-4">
                    <div class="box-model-demo h-100 text-center">
                        ...
                        <p class="text-muted">Siap melayani sampai ujung Indonesia.</p>
                    </div>
                </article>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-6">
                        <div class="text-center mb-4">
                            <h2>Dapatkan Harga Spesial AKHIR TAHUN</h2>
                            <p class="text-muted">Minimal pembelian 10 jenis dessert yang berbeda</p>
                        </div>
                        ...
                        <form action="#" method="POST" class="p-4 border rounded shadow-sm bg-light">
                            ...
                            <button type="submit" class="btn btn-primary w-100 fw-bold py-2">Pesan Sekarang <i class="fa-solid fa-paper-plane ms-1"></i></button>
                        </form>
                    </div>
                </div>
            </div>
